...
function DashboardLayoutWithoutProviders({ children }: DashboardLayoutProps) {
        ...
        children: isWalletConnected ? (
          <div className="flex flex-1 items-center justify-between">
            <div className="flex items-center">
              <NavVerticalSeparator className="mr-[1.675rem]" />
              <NavListHorizontal>
                          ...
                          <Link href={item.href} target={item.isExternal ? '_blank' : undefined}>
                            ...
                            {item.isExternal && (
                              <DropdownMenuItemIconWrapper className="ml-auto">
                                <ExternalLinkIcon className="text-fg/50" />
                              </DropdownMenuItemIconWrapper>
                            )}
                          </Link>
                        </DropdownMenuItem>
                        ...
                        <span className="inline-flex items-center gap-2.5">
                          <span className="h-4 w-4 shrink-0">
                            {clusterStatus.type === 'success' ? (
                              ...
                              <CircleEllipsisIcon className="h-4 w-4 text-fg/60" />
                            )}
                          </span>
                              ...
                              >
                                ...
                                {config.label === clusterConfig.label &&
                                  (clusterStatus.type === 'success' ? (
                                    ...
                                    <CircleEllipsisIcon className="h-[1.05rem] w-[1.05rem] text-fg/60" />
                                  ))}
                              </span>
                            </Button>
                          )}
